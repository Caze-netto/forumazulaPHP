...
<div class="vertical-progress"><div class="vertical-progress-bar" id="progress-bar"></div></div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('scroll', () => {
        const articleHeight = conteudoRenderizado.offsetHeight;
        const articleTop = conteudoRenderizado.offsetTop - 60; // cabeçalho fixo
        const scrollY = window.scrollY;
        const progress = Math.min(Math.max((scrollY - articleTop) / articleHeight * 100, 0), 100);
